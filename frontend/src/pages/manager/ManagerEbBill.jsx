  ...
  return (
    <AppLayout>
      ...
      {loadingBuildings || loadingConfig ? (
        ...
        <div className="card p-6 flex flex-col gap-4 max-w-xl border-blue-100 bg-blue-50/20">
        ...
        <div className="fade-in">
          <div className="mb-4 bg-slate-50 border border-slate-100 rounded-xl p-3.5 text-xs text-slate-500 font-semibold flex items-center gap-2">
                ...
                <div style={{ marginTop: '1rem', marginBottom: '1.5rem', background: 'var(--bg-secondary)', padding: '1rem', borderRadius: 8 }}>
                  ...
                  {readings.map((r, i) => (
                    <div key={i} style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr auto', gap: '0.5rem', marginBottom: '0.5rem', alignItems: 'end' }}>
                      <div>
                        <label className="form-label" style={{ fontSize: '0.75rem' }}>Guest ID</label>
                        <input 
                          className="form-input" 
                          value={r.guestId} 
                      ...
                      <div>
                        <label className="form-label" style={{ fontSize: '0.75rem' }}>Previous</label>
                        <input 
                          type="number" 
                          step="0.01" 
                          className="form-input" 
                      ...
                      <div>
                        <label className="form-label" style={{ fontSize: '0.75rem' }}>Current</label>
                        <input 
                          type="number" 
                          step="0.01" 
                          className="form-input" 
